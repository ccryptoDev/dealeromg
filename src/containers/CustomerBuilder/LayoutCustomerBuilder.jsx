    ...
    <div className="flex flex-col bg-[#002E5D] px-[40px] pb-[40px] 2xl:text-[14px] text-[12px]">
      ...
      <div className="flex  bg-[#F5F9FF] rounded-xl">
        ...
        {!rightMenuCollapse ? (
          ...
          <div className="p-2 2xl:text-[14px] text-[12px] w-[20%] bg-[#FFFFFF] rounded-r-xl z-10">
            <CollapsingButton side="right" start="open" />
            <RightSideContainer />
          </div>
        )}
...
export default LayoutCustomerBuilder
