...
import {
  ...
  defaultResultModule,
} from "../../util/defaultFilterValuesCampaigns"
...
const FilterModule = () => {
  const [filters, setFilters] = useRecoilState(filterInventoryBuilder)
  ...
  const [valueViews, setValueViews] = useState([0, 6000])
  ...
  const valuesInvBuilder = useRecoilState(valuesInventoryBuilder)[0]
